...
import { MIN_CHARITY_CONTRIBUTION_PCT, MAX_CHARITY_CONTRIBUTION_PCT } from "@/lib/config/constants";

export default function SignupPage() {
  const [contributionPct, setContributionPct] = useState<number>(MIN_CHARITY_CONTRIBUTION_PCT);
          ...
          <form action={formAction} className="space-y-4">
            ...
            <div className="space-y-2 rounded-xl border border-slate-800 bg-slate-900/40 p-3.5">
              ...
              <p className="text-[11px] text-slate-400">
                Minimum 10% of your subscription fee goes directly to support charitable causes. You can adjust this anytime.
              </p>
            </div>
